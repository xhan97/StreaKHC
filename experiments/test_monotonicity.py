...
from src.streakhc.utils.serialize_trees import serliaze_tree_to_file_with_node_ds
...
def grid_search_inode(data_path, psi, t, m, file_name, exp_dir_base):
    ...
    serliaze_tree_to_file_with_node_ds(max_root, os.path.join(exp_dir_base, "tree.tsv"))
...
if __name__ == "__main__":
    # main()
    data_path = "./data/shuffle_data/2022-08-25-18-47-42-054/wine_2.csv"
    m = 44
    t = 200
    psi = [3, 5, 10, 17, 21, 25]
    file_name = "wine"
